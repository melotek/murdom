...
function SvgBathroom(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg viewBox="0 0 113 83" fill="none" {...props}>
      <path fill={props.color} d="M47 30h2v2h-2z" style={	{transition: "fill .2s ease-in"}}/>
      <path
        d="M32.5 26l-7.086 7M23.5 35l-2 2"
				style={	{transition: "stroke .2s ease-in"}}
        stroke={props.color}
        strokeWidth={2}
        strokeLinecap="round"
      />
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path stroke={props.color} style={	{transition: "stroke .2s ease-in"}} strokeWidth={2.5} d="M91 7.75h18" />
      <rect
        x={44}
        y={21}
        width={8}
      ...
      <rect
        ...
        strokeWidth={2}
      />
      <path fill={props.color} d="M4 30h2v2H4z" 	style={	{transition: "fill .2s ease-in"}}/>
      <path d="M75 53V37.5" stroke={props.color} strokeWidth={2} 	style={	{transition: "stroke .2s ease-in"}}/>
      <path
      ...
      <path
        ...
        stroke={props.color}	style={	{transition: "stroke .2s ease-in"}}
        strokeWidth={2}
      />
      <path stroke={props.color}	style={	{transition: "stroke .2s ease-in"}} d="M70.5 48.5h1v3h-1zM78.5 48.5h1v3h-1z" />
      <path
        d="M39 57c0 7.732-5.596 14-12.5 14S14 64.732 14 57M13.735 52h25.53a1 1 0 01.99.859l.429 3a1 1 0 01-.99 1.141H13.306a1 1 0 01-.99-1.141l.429-3a1 1 0 01.99-.859zM60.19 74.221l.3.116a2 2 0 01.745 3.231l-3.077 3.297a2 2 0 01-1.462.635h-2.07a.983.983 0 01-.768-1.597l4.052-5.065a2 2 0 012.28-.617zM93.24 74.56l-.115.038c-1.443.48-1.844 2.33-.729 3.365l2.701 2.504a2 2 0 001.36.533h2.636a.744.744 0 00.546-1.249l-4.3-4.65a2 2 0 00-2.1-.54z"	style={	{transition: "stroke .2s ease-in"}}
        stroke={props.color}
        strokeWidth={2}
      />
    </svg>
