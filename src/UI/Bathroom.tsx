...
function SvgBathroom(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg viewBox="0 0 113 83" fill="none" {...props}>
      <path fill={theme.palette.primary.main} d="M47 30h2v2h-2z" />
      <path
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <path stroke={theme.palette.primary.main} strokeWidth={2.5} d="M91 7.75h18" />
      <rect
        x={44}
        y={21}
        width={8}
      ...
      <rect
        ...
        strokeWidth={2}
      />
      <path fill={theme.palette.primary.main} d="M4 30h2v2H4z" />
      <path d="M75 53V37.5" stroke={theme.palette.primary.main} strokeWidth={2} />
      <path
      ...
      <path
        ...
        strokeWidth={2}
      />
      <path stroke={theme.palette.primary.main} d="M70.5 48.5h1v3h-1zM78.5 48.5h1v3h-1z" />
      <path
