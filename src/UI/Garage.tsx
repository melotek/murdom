...
function SvgGarage(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg viewBox="0 0 111 81" fill="none" {...props}>
      ...
      />
      <path stroke={props.color} strokeWidth={2} d="M16 8h79v72H16z" />
      <rect
        x={1}
        y={1}
        width={109}
        ...
        strokeWidth={2}
      />
      <path stroke={props.color} strokeWidth={2} d="M16 17h80" />
      <path
        stroke={props.color}
        strokeWidth={3}
        strokeLinecap="round"
      ...
      <path
        ...
        strokeWidth={2}
      />
      <rect x={67} y={34} width={10} height={3} rx={0.5} fill={props.color} />
      <path
