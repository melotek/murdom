...
function SvgGarage(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg  viewBox="0 0 111 81" fill="none" {...props}>
      ...
      />
      <path 	style={	{transition: "stroke .2s ease-in"}} stroke={props.color} strokeWidth={2} d="M16 8h79v72H16z" />
      <rect	style={	{transition: "stroke .2s ease-in"}}
        ...
        strokeWidth={2}
      />
      <path stroke={props.color} strokeWidth={2} d="M16 17h80" 	style={	{transition: "stroke .2s ease-in"}}/>
      <path
				style={	{transition: "stroke .2s ease-in"}}
        stroke={props.color}
        strokeWidth={3}
      ...
      <path
        ...
        strokeWidth={2}
      />
      <rect x={67} y={34} width={10} height={3} rx={0.5} fill={props.color} 	style={	{transition: "fill .2s ease-in"}}/>
      <path	style={	{transition: "stroke .2s ease-in"}}
