  ...
  return (
    <svg viewBox="0 0 100 79" fill="none" {...props}
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={5} cy={30} r={4} 	style={	{transition: "stroke .2s ease-in"}} stroke={props.color} strokeWidth={2} />
      <circle cx={95} cy={30} r={4} 	style={	{transition: "stroke .2s ease-in"}} stroke={props.color} strokeWidth={2} />
      <path
				style={	{transition: "stroke .2s ease-in"}}
